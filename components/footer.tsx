    ...
    <div className="footer">
      <div className="footer-links">
        <i
          ...
          onClick={() => window.open("https://github.com/isaac-3")}
        ></i>
        <svg
          fill="#ffffff"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 50"
          onClick={() => window.open("https://medium.com/@isaacgc0596")}
        >
        ...
        {/* <i
          ...
          onClick={() =>
            window.open(
              "https://www.youtube.com/channel/UCRGTXv0C5Dn_u7QFid-PYqg?view_as=subscriber"
            )
          }
        ></i> */}
      </div>
      <div className="footer-name">
        <h4>Isaac Chavez © {new Date().getFullYear()}</h4>
      </div>
    </div>
  );
};
